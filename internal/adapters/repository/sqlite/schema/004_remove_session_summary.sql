...
ALTER TABLE active_sessions RENAME TO active_sessions_old;
...
INSERT INTO sessions(id, user_id, length)
SELECT id, user_id, length FROM sessions_old;
...
SELECT user_id, session_id FROM active_sessions_old;

INSERT INTO session_messages(id, session_id, role, content, created_at)
SELECT id, session_id, role, content, created_at FROM session_messages_old;

INSERT INTO tasks(id, user_id, session_id, source_task, request, image, status, error, timeline, context, progress_message_id, result_message_id)
...
DROP TABLE active_sessions_old;
